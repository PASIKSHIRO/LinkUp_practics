...
# # Hints
#
# Ruby doesn't have a built-in stack, but the standard ArrayExtensions has all the methods you need to emulate one (namely, `push` and `pop`, and optionally `size`).
#
